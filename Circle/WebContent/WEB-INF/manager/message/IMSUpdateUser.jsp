...
<form action="${ctx}/UpdateUser" name="form" method="post">
    <ul>
        <li class="common mart6">
            <div class="addborder"><span class="flo_left wid120 textshen">用户名</span><input type="text" name="name" value="${updateuser.name}" class="inpbor wid200"></div>
        </li>
        <li class="common mart6">
            <div class="addborder">
    ...
    <input type="hidden" name="id" value="${updateuser.id}"></form>
