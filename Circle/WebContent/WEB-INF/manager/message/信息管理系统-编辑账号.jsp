...
<div class="location">当前位置:帐户管理 &gt; 编辑帐户</div>
<form action="http://szyunwo.gotoip2.com/jzadmin/Admin/addadmin.htm" name="form" method="post">
    <ul>
        <li class="common mart6">
            <div class="addborder"><span class="flo_left wid120 textshen">用户名</span><input type="text" name="username" value="" class="inpbor wid200"></div>
        </li>
        <li class="common mart6">
            <div class="addborder">
                <span class="flo_left wid120 textshen">密  码</span><input type="password" name="password" value="" class="inpbor wid200">
            </div>
        </li>
        <li class="common mart6">
            <div class="addborder">
