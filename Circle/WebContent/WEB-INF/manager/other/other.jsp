...
<!-- saved from url=(0060)http://szyunwo.gotoip2.com/jzadmin/Index/index/act/other.htm -->
...
<link rel="stylesheet" type="text/css" href="${ctx}/resource/css/css.css">
	<script type="text/javascript" language="javascript">
		function ChangeChannel(orderid){
			...
			if(orderid ==1)
			{
				document.getElementById("mainframe2").src="${ctx}/other/otherTypeList";
			}
			else if(orderid ==2)
			{
				document.getElementById("mainframe2").src="${ctx}/other/showotherTypeAdd";
			}else if(orderid ==3){
				document.getElementById("mainframe2").src="${ctx}/other/otherImsList";
			}else if(orderid ==4){
				document.getElementById("mainframe2").src="${ctx}/other/showotherImsAdd";
			}


		}
	</script>
<meta name="__hash__" content="1b7720506d313d914cca7da779c3cdd5_a6e07976011cbe5c66eab0c420b7ff01"></head>
...
<div class="menu">
	...
	<div class="menu_right">
		...
		<ul>
				...
				<li><a href="${ctx}/other/other" class="sel">其他管理</a></li>
...
<div class="mainframe2">
	<iframe src="${ctx}/other/otherTypeList" id="mainframe2" style="width:100%;height:100%;*height:100%;border:0; background:none; overflow-x:no-display; overflow-y:scroll;"></iframe>
</div>
