...
<body>
	...
	<div class="location">当前位置:文章管理 &gt; 类别管理 &gt; 分类添加</div>
	<form action="${ctx}/essay/essayTypeAdd" name="form" method="post">
		<ul>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">分类名称</span><input
						name="etName" value="" class="inpbor wid200">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
			...
			<li class="submitbtn flo_left"><input type="hidden" name="mod"
				value="5"><input type="submit" name="anniu" value="提 交"></li>
		</ul>
	</form>
