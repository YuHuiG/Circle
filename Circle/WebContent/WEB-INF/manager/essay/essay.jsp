...
<!-- saved from url=(0063)http://szyunwo.gotoip2.com/jzadmin/Index/index/act/wenzhang.htm -->
...
<link rel="stylesheet" type="text/css" href="${ctx}/resource/css/css.css">
	<script type="text/javascript" language="javascript">
		function ChangeChannel(orderid){
			...
			if(orderid ==1) {
				document.getElementById("mainframe2").src="${ctx}/essay/essayTypeList";
			}
			else if(orderid ==2) {
				document.getElementById("mainframe2").src="${ctx}/essay/showessayTypeAdd";
			}else if(orderid ==3){
				document.getElementById("mainframe2").src="${ctx}/essay/essayImsList";
			}else if(orderid ==4){
				document.getElementById("mainframe2").src="${ctx}/essay/showessayImsAdd";
			}


		}
	</script>
<meta name="__hash__" content="f81e95d428774c40de98b6d7e57a531e_5d8a63ecc4acb24995f2df5ff3631cf7"></head>
...
<div class="menu">
	...
	<div class="menu_right">
		...
		<ul>
			...
			<li><a href="${ctx}/essay/essay" class="sel">文章管理</a></li>
...
<div class="mainframe2">
	<iframe src="${ctx}/essay/essayTypeList" id="mainframe2" style="width:100%;height:100%;*height:100%;border:0; background:none; overflow-x:no-display; overflow-y:scroll;"></iframe>
</div>
