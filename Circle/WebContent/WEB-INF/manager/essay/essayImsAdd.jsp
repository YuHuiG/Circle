...
<body>
	...
	<div class="location">当前位置:文章管理 &gt; 信息管理 &gt; 信息添加</div>
	<form action="${ctx}/essay/essayImsAdd" name="form" method="post">
		<ul>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">标题</span><input
						name="emTitle" value="" class="inpbor wid350">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">所属分类</span> <select
						...
						<c:forEach items="${stype}" var="s">
							<option value="${s.etId}" disabled="disabled">${s.etName }</option>
							<c:forEach items="${btype}" var="b">
								<c:if test="${s.etId==b.etIds}">
									<option value="${b.etName }" >&nbsp;&nbsp;&nbsp;└──&gt;${b.etName }</option>
								</c:if>
							</c:forEach>
						</c:forEach>
					</select>
			...
			<li class="common mart6">
				<div class="addborder">
					...
					<p>
						<input type="text" name="emImg" id="thumb" value=""> <input
			...
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">来源</span><input
						name="emSource" value="" class="inpbor wid350">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">发布日期</span><input
						placeholder="请输入日期" class="laydate-icon" value="" name="emDate"
			...
			<li class="common mart6">
				<div class="addborder">
					...
					<textarea name="emBrief" class="wid350" rows="5"></textarea>
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">标签</span>
					<textarea name="emLable" class="wid350" rows="5">		</textarea>
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
			...
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">浏览量</span><input
						name="emNum" value="" class="inpbor wid60">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">排序</span><input
						name="emSort" value="" class="inpbor wid60">
				</div>
			</li>
