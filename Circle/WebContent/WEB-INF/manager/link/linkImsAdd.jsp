...
<body>
	...
	<form action="${ctx }/link/linkImsAdd" name="form" method="post">
		<ul>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">标题</span><input
						name="lmTitle" value="" class="inpbor wid350">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
			...
			<li class="common mart6">
				<div class="addborder">
					...
					<p>
						<input type="text" name="lmImg" id="thumb" value=""> <input
			...
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">连接地址</span><input
						name="lmUrl" value="" class="inpbor wid350">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">排序</span><input
						name="lmSort" value="" class="inpbor wid60">
				</div>
			</li>
