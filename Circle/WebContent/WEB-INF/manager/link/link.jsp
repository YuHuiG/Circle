...
<!-- saved from url=(0059)http://szyunwo.gotoip2.com/jzadmin/Index/index/act/link.htm -->
...
<link rel="stylesheet" type="text/css" href="${ctx}/resource/css/css.css">
	<script type="text/javascript" language="javascript">
		function ChangeChannel(orderid){
			...
			if(orderid ==1) {
				document.getElementById("mainframe2").src="${ctx}/link/linkTypeList";
			}
			else if(orderid ==2) {
				document.getElementById("mainframe2").src="${ctx}/link/showlinkTypeAdd";
			}else if(orderid ==3){
				document.getElementById("mainframe2").src="${ctx}/link/linkImsList";
			}else if(orderid ==4){
				document.getElementById("mainframe2").src="${ctx}/link/showlinkImsAdd";
			}

		}
	</script>
<meta name="__hash__" content="73a8bda1ce7a1df5066286bb58b031ea_a4c2df78ed4bbbad8c6f0ea1eced63ff"></head>
...
<div class="menu">
	...
	<div class="menu_right">
		...
		<ul>
			...
			<li><a href="${ctx}/link/link"  class="sel">链接管理</a></li>
...
<div class="mainframe2">
	<iframe src="${ctx}/link/linkTypeList" id="mainframe2" style="width:100%;height:100%;*height:100%;border:0; background:none; overflow-x:no-display; overflow-y:scroll;"></iframe>
</div>
