...
<body>
	...
	<div class="location">当前位置:选项目 &gt; 类别管理 &gt; 编辑分类</div>
	<form action="${ctx}/project/projectTypeUpdate" name="form"
		method="post">
		<ul>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">分类名称</span><input
						name="pName" value="${proj.pName}" class="inpbor wid200">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					...
					<script type="text/javascript">
						document.getElementById("pIds").value = '${proj.pIds}';
					</script>
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">排序</span><input name="pSort"
						value="${proj.pSort}" class="inpbor wid60">
				</div>
			</li>
			<li class="submitbtn flo_left"><input type="hidden" name="pId"
				value="${proj.pId}"><input type="submit" name="anniu" value="提 交"></li>
		</ul>
