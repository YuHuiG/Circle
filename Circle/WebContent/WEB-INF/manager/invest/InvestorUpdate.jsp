...
<body>
	...
	<form action="${ctx }/invest/investorUpdate" name="form" method="post">
		<ul>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">姓名</span><input
						name="iumName" value="${itor.iumName }" class="inpbor wid200">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">副标题</span><input
						name="iumSubhead" value="${itor.iumSubhead }"
						class="inpbor wid200">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					...
					<p>
						<input type="text" name="iumHead" id="thumb"
							value="${itor.iumHead }"> <input type="button" id="logo"
							value="选择图片">(尺寸：179*218px)
					</p>
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">投资阶段</span><input
						name="iumInveststage" value="${itor.iumInveststage }"
						class="inpbor wid350">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">投资方式</span><input
						name="iumInvestmethod" value="${itor.iumInvestmethod }"
						class="inpbor wid200">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">所在地</span><input
						name="iumArea" value="${itor.iumArea }" class="inpbor wid200">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">约见地区</span><input
						name="iumAppointmentarea" value="${itor.iumAppointmentarea }"
						class="inpbor wid200">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">约见费用</span><input
						name="iumMoney" value="${itor.iumMoney }" class="inpbor wid200">元/次
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">机构简介</span>
					<textarea name="iumBrief" class="wid350" rows="5">${itor.iumBrief }</textarea>
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">成功案例文字</span>
					<textarea name="iumCasetext" class="wid350" rows="5">	${itor.iumCasetext }</textarea>
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">投资领域</span>
					<textarea name="iumField" class="wid350" rows="5">${itor.iumField }	</textarea>
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					...
					<div class="ke-container ke-container-default"
						style="width: 700px;">
						<textarea name="iumDetail"
							style="width: 700px; height: 200px; visibility: hidden; display: none;">${itor.iumDetail }</textarea>
					</div>
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">游览量初始值</span><input
						name="iumNum" value="${itor.iumNum }" class="inpbor wid60">
				</div>
			</li>
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">排序</span><input
						name="iumSort" value="${itor.iumSort }" class="inpbor wid60">
				</div>
			</li>
			<li class="submitbtn flo_left"><input type="hidden" name="iumId"
				value="${itor.iumId }"><input type="submit" name="anniu"
				value="提 交"></li>
		</ul>
