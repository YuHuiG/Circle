			...
			<li class="common mart6">
				<div class="addborder">
					<span class="flo_left wid120 textshen">排序</span><input
						name="itSort" value="${itype.itSort }" class="inpbor wid60">
				</div>
			</li>
			<li class="submitbtn flo_left"><input type="hidden" name="itId"
				value="${itype.itId}"><input type="submit" name="anniu" value="提 交"></li>
		</ul>
